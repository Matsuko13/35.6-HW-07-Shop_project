...
const HomePage: FunctionComponent = () => {
  ...
  const overview = useAppSelector((state: { products: { overview: any } }) => state.products.overview);
  const loading = useAppSelector((state: { products: { loading: any } }) => state.products.loading);
  useEffect(() => {dispatch(fetchInfo());}, [dispatch]);
  return (
    <Layout>
