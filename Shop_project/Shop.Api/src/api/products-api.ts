...
import { IProductEntity, ICommentEntity, IProductSearchFilter, ProductCreatePayload, IImageEntity, ImageCreatePayload, ProductAddImagesPayload, ImagesRemovePayload, IProductImageEntity } from "../../types";
import { enhanceProductsCommentsAndImages, getProductsFilterQuery } from "../helpers";
import { ResultSetHeader } from "mysql2";
import { DELETE_IMAGES_QUERY, INSERT_IMAGE_QUERY, INSERT_PRODUCT_IMAGES_QUERY, INSERT_PRODUCT_QUERY, REPLACE_PRODUCT_THUMBNAIL, UPDATE_PRODUCT_FIELDS } from "../services/queries";
...
productsRouter.get('/', async (req: Request, res: Response) => {
    try {
        ...
        const [imagesRows] = await connection!.query < IImageEntity[] > ("SELECT * FROM images");
